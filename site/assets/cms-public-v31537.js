...
(function(){
    ...
    const graph=[
      {
        ...
        'inLanguage':'ko-KR',
        'dateModified':(slug==='damjeok'||slug==='bopye'||slug==='pain'||slug==='menopause')?'2026-09-16':undefined,
        'author':(slug==='damjeok'||slug==='bopye'||slug==='pain'||slug==='menopause')?{'@type':'Person','name':'차민재','jobTitle':'한의사','url':'https://www.jshhani.com/doctor.html','worksFor':{'@id':'https://www.jshhani.com/#clinic'}}:undefined,
  ...
  async function renderDetail(){
    ...
    try{
      ...
      const isMenopauseMainTemplate=(html)=>String(html||'').includes('data-menopause-main-template="v31537"');
      ...
      const painTemplate=(slug==='pain' && window.JSH_PAIN_MAIN_TEMPLATE)
        ...
        : '';
      const menopauseTemplate=(slug==='menopause' && window.JSH_MENOPAUSE_MAIN_TEMPLATE)
      ...
      if(slug==='menopause' && menopauseTemplate && !isMenopauseMainTemplate(pinned?.content_html)){
      ...
      root.innerHTML=`
        ...
        <section class="featured">
          <div class="container">
            ...
            ${(pinned || (slug==='diet' && dietTemplate) || (slug==='bopye' && bopyeTemplate) || (slug==='damjeok' && damjeokTemplate) || (slug==='pain' && painTemplate) || (slug==='menopause' && menopauseTemplate)) ? `
