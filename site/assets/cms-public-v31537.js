    ...
    const graph=[
      {
        ...
        'author':(slug==='damjeok'||slug==='bopye'||slug==='pain'||slug==='menopause')?{'@type':'Person','name':'차민재','jobTitle':'한의사','url':'https://jshhani.com/doctor.html','worksFor':{'@id':'https://jshhani.com/#clinic'}}:undefined,
