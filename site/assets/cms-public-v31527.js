...
(function(){
  ...
  const DETAIL_SEO={
    ...
    bopye:{title:'청주 보폐고엔오·호흡기 진료 | 제세현한의원',description:'쉰목소리, 인후 불편감 등 목과 호흡기 증상에 대한 제세현한의원 보폐고엔오·호흡기 진료 안내입니다.'},
    ...
    const graph=[
      {
        ...
        'inLanguage':'ko-KR',
        'dateModified':slug==='damjeok'?'2026-09-16':undefined,
        'author':slug==='damjeok'?{'@type':'Person','name':'차민재','jobTitle':'한의사','url':'https://www.jshhani.com/doctor.html','worksFor':{'@id':'https://www.jshhani.com/#clinic'}}:undefined,
  ...
  async function renderDetail(){
    ...
    try{
      ...
      const isBopyeMainTemplate=(html)=>String(html||'').includes('data-bopye-main-template="v31518"');
